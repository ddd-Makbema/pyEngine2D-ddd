...
def init_game():
	...
	screen = ScreenInit(360,480, 60, 100, "pyEngine2D/data/null.png", "MyGame")
	GO("collision handler", screen, "pyEngine2D/data/null.png", "origin", "Collider2D.CollisionHandler")
	GO("origin", screen, "pyEngine2D/data/null.png", "origin", "transform.Transform")
