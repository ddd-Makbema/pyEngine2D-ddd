...
GO("collision handler", screen.screen, "null.png",
   "origin", "Collider2D.CollisionHandler")

GO("origin", screen.screen, "null.png", "origin", "transform.Transform")

GO("sam", screen.screen, "null.png", "origin", "transform.Transform",
   "Collider2D.RectangleCollider2D", "player_movement.PlayerMovement")
...
GO("katz", screen.screen, "null.png", "origin", "transform.Transform",
   "Collider2D.RectangleCollider2D", "player_movement.PlayerMovement")
